...
public class GenericDao {
	...
	public void save(Object obj) {
		...
		try {
			emf = Persistence.createEntityManagerFactory("account-transaction"); //META-INF/persistence.xml
	...
	public void deleteById(Class clazz,int id) {
		EntityManagerFactory emf = null;
		try {
			emf = Persistence.createEntityManagerFactory("account-transactione"); //META-INF/persistence.xml
			EntityManager em = emf.createEntityManager();
			em.getTransaction().begin();
			Object obj = em.find(clazz, id);
			em.remove(obj);
